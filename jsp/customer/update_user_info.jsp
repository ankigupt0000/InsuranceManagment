...
<form action="Action/update_user_info.jsp" method="post" onSubmit="return checkAll()">
<div align="center"><h1>Update User Information</h1></div>
<%
try{
...
<table width="80%" align="center" border="0">
  ...
  <tr>
    <td>Occupation:</td>
    <td><input name="occupation" id="occupation" type="text" size="20" maxlength="20" value="<%= rs.getString("occupation")%>"></td>
  </tr>
  <tr>
    <td>Annual Income:</td>
    <td><input name="annual_incom" id="annual_incom" type="text" size="11" maxlength="11" value="<%= rs.getString("annual_incom")%>"></td>
  </tr>
  <tr bgcolor="#dddddd">
